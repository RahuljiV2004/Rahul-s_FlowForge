...
#     def create_embedding_openai(self, text: str) -> List[float]:
...
#     def create_embedding_gemini(self, text: str) -> List[float]:
...
#     def create_embedding(self, text: str, knowledge_base_id: str, metadata: Dict, embedding_model: str = "openai") -> str:
...
#     def search_similar(self, query: str, knowledge_base_id: str, top_k: int = 5, embedding_model: str = "openai") -> List[Dict]:
